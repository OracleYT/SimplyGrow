...
// //------------------------------------------------------------------------------
// //--------------------Flash card API-----------------------------------------------
//   static Future<List<FlashCard>> getFlashCards(String token) async {
//     String baseUrl = baseApi;
...
//   static Future<List<FlashCardProgress>> checkFlashResponseGiven({
//     String token,
//     String date,
//   }) async {
//     String baseUrl = await Utils.getBaseUrlFromLocal();
...
//         : baseApi + "check_flash_response_given";
